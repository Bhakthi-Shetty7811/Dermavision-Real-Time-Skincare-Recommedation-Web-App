...
const SkincareEffectApp = () => {
  const videoRef = useRef(null);
  const canvasRef = useRef(null);

  const [stream, setStream] = useState(null);
  const [effect, setEffect] = useState("Face-Moisturizers");
  ...
  return (
    <div style={{ textAlign: "center", padding: "20px" }}>
      ...
      <video
  ref={videoRef}
  style={{ width: "60%", borderRadius: "8px", marginBottom: "20px" }}
  autoPlay
  muted
/>
...
export default SkincareEffectApp;
